...
public class Dao {
	...
	public Dao() {
		factory = new Configuration().configure("bi_directional/hibernate.xml").addAnnotatedClass(InstructorEntity.class)
	...
	public InstructorDetailsEntity fetchInstrDetailsEntityByID(Long id) {
		session =factory.getCurrentSession();
		return session.find(InstructorDetailsEntity.class, 1);
	}
